...
import ssl
from collections.abc import AsyncGenerator, AsyncIterator, Awaitable, Callable, Iterable, Mapping, MutableMapping
...
class Redis(AbstractRedis, AsyncRedisModuleCommands, AsyncCoreCommands, AsyncSentinelCommands):
    ...
    def __await__(self) -> AsyncGenerator[Any, Any, Self]: ...
    ...
    async def aclose(self, close_connection_pool: bool | None = ...) -> None:
        """
    ...
    async def parse_response(self, connection: Connection, command_name: str | bytes, **options) -> None:
        """Parses a response from the Redis server"""

    def smembers(self, name: str) -> Awaitable[list[bytes]]:
        """
...
class PubSub:
    ...
    def __init__(
        ...
        encoder=...,
        push_handler_func: Callable | None = ...,
    ) -> None: ...
    async def __aenter__(self):  # -> Self:
        ...
    async def __aexit__(self, exc_type, exc_value, traceback):  # -> None:
    ...
    async def run(
        self, *, exception_handler: PSWorkerThreadExcHandlerT | None = ..., poll_timeout: float = ...
    ) -> None:
